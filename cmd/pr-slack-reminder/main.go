...
func main() {
	...
	// The runner reads a workflow command only at a line's start. See docs/third-party-facts.md
	// § The runner parses workflow commands from stderr as well as stdout, but only at a line's start
	log.SetFlags(0)
