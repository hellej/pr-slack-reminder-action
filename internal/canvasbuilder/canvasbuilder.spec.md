...
- WIP PR row: linked title, author, commenters, then the activity text, styled as a code span when `prparser.IsRecentlyUpdated` and in italics otherwise. Unknown activity renders no activity segment at all
